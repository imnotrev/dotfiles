...
awful.screen.connect_for_each_screen(function(s)
    ...
    s.logo:connect_signal("button::press",
    function()
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey },            "f",     function () awful.spawn.with_shell("rofi -show drun") end,
...
awful.spawn.with_shell("feh --randomize --bg-scale Wallpaper")
